...
#     x = Variable("x")
#     y = Variable("y")
#     builder = LocalDifferentialBuilder(Constant(23), Point(w = 7, x = 8, y = 9))
#     builder.add_to(x, 3)
#     builder.add_to(y, 4)
#     builder.add_to(y, 2)
...
#     x = Variable("x")
#     y = Variable("y")
#     builder_a = LocalDifferentialBuilder(Constant(23), Point(x = 8, y = 9))
#     builder_a.add_to(x, 3)
#     builder_a.add_to(y, 4)
#     local_differential_a = builder_a.build()
#     builder_b = LocalDifferentialBuilder(Constant(23), Point(y = 9, x = 8))
...
#     builder_c = LocalDifferentialBuilder(Constant(23), Point(x = 8, y = 9))
