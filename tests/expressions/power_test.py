...
def test_Power():
    ...
    assert local_differential.partial_with_respect_to(x) == approx(12.990381056)
    assert local_differential.partial_with_respect_to(y) == approx(17.125670716)
    assert global_differential.partial_at(point, x) == approx(12.990381056)
    assert global_differential.partial_at(point, y) == approx(17.125670716)
    # at (x, y) = (3, 0)
    point = Point({x: 3, y: 0})
    ...
    local_differential = z.compute_local_partials(point)
    assert local_differential.partial_with_respect_to(x) == approx(0)
    assert local_differential.partial_with_respect_to(y) == approx(1.0986122886)
    assert global_differential.partial_at(point, x) == approx(0)
    assert global_differential.partial_at(point, y) == approx(1.0986122886)
    # at (x, y) = (3, -2.5)
    point = Point({x: 3, y: -2.5})
    ...
    local_differential = z.compute_local_partials(point)
    assert local_differential.partial_with_respect_to(x) == approx(-0.0534583582)
    assert local_differential.partial_with_respect_to(y) == approx(0.0704760111)
    assert global_differential.partial_at(point, x) == approx(-0.0534583582)
    assert global_differential.partial_at(point, y) == approx(0.0704760111)
    # at (x, y) = (0, 2.5)
...
def test_Power_composition():
    ...
    local_differential = z.compute_local_partials(point)
    assert local_differential.partial_with_respect_to(x) == approx(24)
    assert local_differential.partial_with_respect_to(y) == approx(16.63553233343)
    global_differential = z.compute_global_partials()
    assert global_differential.partial_at(point, x) == approx(24)
    assert global_differential.partial_at(point, y) == approx(16.63553233343)
...
def test_Power_with_constant_exponent_two():
    ...
    assert global_differential.partial_at(point, x) == approx(6)
    # at y = 0
    point = Point({x: 0})
...
def test_Power_with_constant_exponent_negative_one():
    ...
    assert global_differential.partial_at(point, x) == approx(-0.04)
...
def test_Power_with_constant_exponent_negative_two():
    ...
    assert global_differential.partial_at(point, x) == approx(0.016)
