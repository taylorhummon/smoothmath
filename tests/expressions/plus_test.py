...
def test_Plus():
    ...
    assert z.synthetic_partial(x).evaluate(variable_values) == 1
    assert z.synthetic_partial(y).evaluate(variable_values) == 1
...
def test_Plus_composition():
    ...
    assert z.synthetic_partial(x).evaluate(variable_values) == 5
    assert z.synthetic_partial(y).evaluate(variable_values) == 4
